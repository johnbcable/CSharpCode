...
namespace Exercise02
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            WriteLine($"float\t{sizeof(float)}\t{string.Format("{0:0.###############E+00}", float.MinValue),30:F0}\t{string.Format("{0:0.###############E+00}", float.MaxValue),30:F0}");
            WriteLine($"double\t{sizeof(double)}\t{string.Format("{0:0.###############E+00}", double.MinValue),30:F0}\t{string.Format("{0:0.###############E+00}", double.MaxValue),30:F0}");
