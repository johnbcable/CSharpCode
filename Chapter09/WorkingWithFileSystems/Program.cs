...
namespace WorkingWithFileSystems
{
    class Program
    {
        static void OutputFileSystemInfo() 
        {
            ...
            WriteLine("{0, -40} {1}", "Directory.GetCurrentDirectory()", GetCurrentDirectory());
            WriteLine("{0, -40} {1}", "Environment.CurrentDirectory", CurrentDirectory);
            WriteLine("{0, -40} {1}", "Environment.SystemDirectory", SystemDirectory);
            WriteLine("{0, -40} {1}", "Path.GetTempPath()", GetTempPath());
            WriteLine("GetFolderPath(SpecialFolder");
            WriteLine("{0, -40} {1}", "  .System)",GetFolderPath(SpecialFolder.System));
            WriteLine("{0, -40} {1}", "  .ApplicationData)",GetFolderPath(SpecialFolder.ApplicationData));
            WriteLine("{0, -40} {1}", "  .MyDocuments)",GetFolderPath(SpecialFolder.MyDocuments));
            WriteLine("{0, -40} {1}", "  .Personal)",GetFolderPath(SpecialFolder.Personal));
        }
        ...
        static void WorkWithFiles() 
        {
            ...
            arg0: GetFileNameWithoutExtension(textFile));
