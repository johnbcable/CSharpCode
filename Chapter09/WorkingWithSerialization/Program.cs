...
namespace Packt.Shared
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            {
                // serilaize the object graph to the stream
            ...
            {
                // deserialize and cast the object graph into a List or Person
            ...
            // craete a file to write JSON to
            ...
            using (StreamWriter jsonStream = File.CreateText(jsonPath))
            {
                ...
                // serialize the object grpah into a string
